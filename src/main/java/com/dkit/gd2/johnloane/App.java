...
public class App
{
    public static void main( String[] args )
    {
        ...
        oneHundredStrings = new ArrayList<String>(new LinkedHashSet<String>(oneHundredStrings));
        questionThreePartA(oneHundredStrings);
        questionThreePartB("Creating a HashSet from ArrayList would be O(n*log(n)"));

        //Question 4
        compareTwoStudents();
        questionFourPartA("When the hashcode are different then the objects in a equals() method would be false as well.");
        questionFourPartB(" It Changes the hashcode when you add or remove an element in the array.");
        questionFourPartC(" ");
    }
